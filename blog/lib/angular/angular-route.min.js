...
(function(C, d) {
    ...
    var w = d.module("ngRoute", ["ng"]).provider("$route", function() {
        ...
        ;
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", function(a, c, b, f, h, k, x) {
            function l(b) {
                var e = s.current;
                ...
                if (w)
                    ...
                    f.when(e).then(function() {
                        if (e) {
                            ...
                            d.isDefined(c) && (e.loadedTemplateUrl = x.valueOf(c),
                            b = k(c)));
                        ...
                        d.copy(e.params, b)),
                        a.$broadcast("$routeChangeSuccess", e, v))
                    }, function(b) {
